    ...
    useEffect(() => {
        if (!checked.length || !radio.length) {
            if (!filteredProductsQuery.isLoading) {
                // filter products based on checked category and price filter
        ...
        <>
            ...
            <div className="container mx-auto">
                <div className="flex md:flex-row">
                    <div className="bg-[#151515] p-3 mt-2 mb-2">
                                ...
                                <div key={c._id} className="mb-2">
                                    <div className="flex items-center mr-4">
                                        <input type="checkbox" id="red-checkbox"
                                            ...
                                            border-gray-300 rounded focus:ring-orange-500 
                                            dark:focus:ring-orange-600 dark:ring-offset-gray-800 
                                            focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />

                                        <label htmlFor="orange-checkbox"
                            ...
                            {uniqueBrands?.map((brand) => (
                                <>
                                    <div className="flex items-center mr-4 mb-5">
                                        ...
                                        <label htmlFor="orange-radio"
                                            className="ml-2 text-sm font-medium text-white 
                                        dark:text-gray-300" >{brand}</label>
                        ...
                        <div className="p-5 w-[15rem]">
                            <input type="text" placeholder="Enter Price" value={priceFilter}
                                onChange={handlePriceChange} className="w-full px-3 py-2 
                                placeholder-gray-400 border rounded-lg focus:outline-orange-300 
                    ...
                    <div className="p-3">
                        <h2 className="h4 text-center mb-2">{`( ${products?.length} )`} Product/s</h2>
