...
const ProductList = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (data?.error) {
                toast.error("Failed To Create Product, fill all fields and try again!");
            } else {
            ...
            console.error(error);
            toast.error("Failed To Create Product, something goes wrong!");
        }
                    ...
                    <div className="p3">
                        ...
                        <div className="flex justify-between">
                            ...
                            <div>
                                ...
                                <select placeholder="Choose Category"
                                    ...
                                    rounded-lg bg-[#101011] text-white"
                        ...
                        <button
                            ...
                            className="py-4 px-10 mt-5 rounded-lg 
                                text-lg font-bold bg-orange-500 hover:bg-orange-400">
                            Add Product
                        </button>
