                            ...
                            <div className="flex flex-wrap relative items-between 
                                ...
                                <div>
                                    <img src={product.image} alt={product.name}
                                        className="w-full xl:w-[50rem] lg:w-[45rem] 
                                        md:w-[30rem] sm:w-[20rem] mr-[2rem] 
                                        h-full xl:h-[50rem] lg:h-[45rem] 
                                        md:h-[30rem] sm:h-[20rem] mr-[2rem]" />
                                ...
                                <div className="flex flex-col justify-between">
                                    ...
                                    <div className="flex items-center justify-between w-[20rem]">
                                        <div className="one">
                                            ...
                                            <h1 className="flex items-center mb-6 w-[15rem]">
                                                <FaClock className="mr-2 text-white" />Added At :
                                    ...
                                    <div className="btn-container">
                                        <button
                                            ...
                                            mt-4 md:mt-0">Add To Cart</button>
                                    </div>
