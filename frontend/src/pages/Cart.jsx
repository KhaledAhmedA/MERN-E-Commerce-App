    ...
    return (
        <>
            ...
            <div className="container flex justify-around items-start flex-wrap mx-auto mt-8">
                {cartItems.length === 0 ? (
                    <div>Your Cart Empty, Add Some Items <Link to="/shop"> Go To Shop</Link></div>
                ) : (
                    <>
                        <div className="flex flex-col w-[80%]">
                                ...
                                <div key={item._id} className="flex items-center mb-[1rem] pb-2">
                                    ...
                                    <div className="flex-1 ml-4">
                                        <Link to={`/product/${item._id}`}
                                            className="text-orange-400">{item.name}</Link>
                            ...
                            <div className="mt-8 w-[40rem]">
                                <div className="p-4 rounded-lg">
                                    ...
                                    <button className="bg-orange-500 mt-4 py-2 px-4 rounded-full text-lg w-full"
